...
App.Project.reopenClass({
  FIXTURES:
    [ {
      ...
      projectFilter: "ember",
      projectRepo: 'emberjs/ember.js',
      lastRelease: "1.8.0-beta.1",
      futureVersion: "1.8.0-beta.2",
      finalVersion: '1.8.0',
      channel: "beta",
      cycleEstimatedFinishDate: '2014-10-03',
      date: "2014-08-22",
      nextDate: "2014-08-29",
      changelogPath: "CHANGELOG.md"
    }, {
      ...
      projectFilter: "ember-data",
      projectRepo: 'emberjs/data',
      lastRelease: "1.0.0-beta.9",
      futureVersion: "1.0.0-beta.10",
      channel: "beta",
      date: "2014-08-18",
      changelogPath: "CHANGELOG.md"
    }, {
