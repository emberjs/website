...
App.Project.reopenClass({
  FIXTURES:
    [ {
      ...
      projectFilter: [ /ember\./, /ember-template-compiler/ ],
      projectRepo: 'emberjs/ember.js',
      lastRelease: "2.2.0-beta.1",
      futureVersion: "2.2.0-beta.2",
      finalVersion: '2.2.0',
      channel: "beta",
      cycleEstimatedFinishDate: '2015-11-23',
      date: "2015-10-04",
      nextDate: "2015-10-12",
      changelogPath: "CHANGELOG.md",
      enableTestURL: true,
      ...
      projectFilter: [ /ember-data\./ ],
      projectRepo: 'emberjs/data',
      lastRelease: "2.1.0-beta.5",
      futureVersion: "2.1.0-beta.6",
      finalVersion: '2.1.0',
      channel: "beta",
      date: "2015-09-28",
      changelogPath: "CHANGELOG.md",
