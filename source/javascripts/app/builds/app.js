...
App.Project.reopenClass({
  FIXTURES:
    [ {
      ...
      projectFilter: "ember",
      projectRepo: 'emberjs/ember.js',
      lastRelease: "1.7.0-beta.2",
      futureVersion: "1.7.0-beta.3",
      finalVersion: '1.7.0',
      channel: "beta",
      cycleEstimatedFinishDate: '2014-08-19',
      date: "2014-07-15",
      nextDate: "2014-07-22",
      changelogPath: "CHANGELOG.md"
    }, {
      ...
      projectFilter: "ember-data",
      projectRepo: 'emberjs/data',
      lastRelease: "1.0.0-beta.8",
      futureVersion: "1.0.0-beta.9",
      channel: "beta",
      date: "2014-05-29",
      changelogPath: "CHANGELOG.md"
    }, {
