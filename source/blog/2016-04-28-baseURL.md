...
Note: the `rootURL` is *not* present. This is intentional as `rootURL` exists only to provide information to Ember's Router about where the application is served from.
