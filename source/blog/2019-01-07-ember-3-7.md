...
Note that in Ember.js 3.7 support for Node 4 has been explicitly dropped. This means that if you are Node 4 and want to upgrade you will need to upgrade your version of Node first.
