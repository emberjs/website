Next we'll update our template's hard-coded count of uncompleted todos to reflect the actual number of uncompleted todos. Update `index.html` to use two properties:
