...
In this guide, we'll show you how to build a simple todos app using Ember.js. You can check the app
[here](http://emberjs.com/examples/todos/). Also, you can look the source code [here](https://github.com/emberjs/examples/tree/master/todos).
